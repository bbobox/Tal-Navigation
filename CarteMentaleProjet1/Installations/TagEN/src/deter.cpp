...
static alphabet * developpe(alphabet * d1, alphabet * d2,
   tBiAlph * biAlph, BOOL * modif) ;
static noeud * trier(noeud *liste);
static void affListe(noeud * liste, FILE * f = stderr);
...
static void subst(tSymbole *s, tSymbole *i, alphabet * tab,
   tBiAlph * biAlph) ;
...
static void affListe(noeud * liste, FILE * f) {
